...
const sections = [
  ...
  { id: 'benzimidazoles', label: 'Benzimidazoles', icon: <Pill className="w-4 h-4" />, color: 'text-blue-600' },
  ...
  { id: 'sleepapnea', label: 'Sleep Apnea & Brain', icon: <Moon className="w-4 h-4" />, color: 'text-red-600' },
  { id: 'nutrition', label: 'Nutrition Protocol', icon: <Utensils className="w-4 h-4" />, color: 'text-green-600' },
  ...
  { id: 'diary', label: "Mom's Medical Diary", icon: <Heart className="w-4 h-4" />, color: 'text-pink-600' },
